...
uint256 hashGenesisBlock("0xf4c136c9fde346069d0f6b03ab79c2b9fd3b98b1255ab6308d72691d41b3a08a");
...
const string strMessageMagic = "opeccoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy = (1000000/nHeight) * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = .5 * 24 * 60 * 60; // opeccoin: 1 days
static const int64 nTargetSpacing = 90; // opeccoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal opeccoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "opeccoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6177b9c69a7ed34d5e8c9e4fa61cbee9e7988fe6d26383ad866aeec62d151d9b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "PLEASE WRITE SOMETHING HERE";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388367751; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2560467;

        if (fTestNet)
        {
            block.nTime    = 1388345095;
            block.nNonce   = 3729947;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xd6f6291ffb3e0c94efebffa452ba7f1311289d16b233d9c20039f665e0021c96"));
